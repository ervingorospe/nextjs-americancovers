...
// components
import { Title, Body, SectionButtons, AccordionList } from '@/components/shared'
// constants
...
export async function Accordion({ data, sectionCount }) {
  const { fields } = data
    ...
    <Section className="relative" bg={bg}>
      <Container width={width} margin="section" className="relative z-1 pb-12 md:pb-16">
        <Motion>
          ...
          {
            subCollection && <AccordionList subCollection={subCollection}/>
          }
        </Motion>
      </Container>
    </Section>
