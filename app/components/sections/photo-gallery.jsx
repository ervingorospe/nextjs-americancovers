...
// components
import { Title, Body, SectionButtons, Gallery } from '@/components/shared'
// constants
...
export async function PhotoGallery({ data, sectionCount }) {
  const { fields } = data
        ...
        <Motion>
          ...
          <MotionVariant variants={fadeInFromBottom}>
            <Body
              ...
              size={bodySize}
              className={`${defaults.margin.body} ${_.get(fields, 'bodyClass') ?? _.get(fields, 'bodyClass')} max-w-full text-center mx-auto`}
            />
          </MotionVariant>
