...
export async function HeroSafetyGetAQuoteForm({ data, sectionCount }) {
  const { fields } = data
    ...
    <Section className="relative overflow-hidden" bg={bg}>
      ...
      <Container className="relative z-10 pb-4 lg:pb-0" width={width} margin="hero">        
        <Motion className="grid pt-14 gap-8 lg:grid-cols-12">
          ...
          <GetAQuoteForm 
            settings={settings} 
            className="border-[6px] border-primary-600 lg:col-span-5 pb-24 relative w-full lg:max-w-2xl bg-[#F8F4F6] grid justify-items-center lg:justify-items-center max-h-[600px] overflow-hidden hover:max-h-full ease-in-out duration-1000"
          />
        </Motion>
      </Container>
