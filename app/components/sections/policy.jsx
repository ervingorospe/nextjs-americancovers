...
const defaults = {
  ...
  buttonStyle: 'text-button-underline',
}

export async function Policy({ data, sectionCount }) {
  const { fields } = data
  ...
  return (
    <Section className="relative" bg={bg}>
      <Container width={width} margin="section" className="relative z-1 py-8 lg:mt-64 ">
        <Motion>
          {/* title */}
          ...
          <FormWufoo data={data} 
            className={{ 
              container: "mt-8 grid justify-items-center",
              div: "relative w-full bg-gray-50 max-w-[800px]",
              form: "px-6 pt-6"
            }} 
            titleText=""
          />
