...
export async function VideoRight({ data, sectionCount }) {
  const { fields } = data
  ...
  return (
    <Section className="relative mb-24" bg={bg}>
      <div className="absolute inset-0 bg-secondary-950 opacity-80 z-10"></div>
        ...
        <Container width={width} margin="section" className="relative">
          <Motion className="items-center grid gap-10 lg:grid-cols-2">
            <div className="max-w-full">
              <figure className="aspect-w-16 aspect-h-9 overflow-hidden">
            ...
            <div className="max-w-full lg:row-start-1">
              ...
              <MotionVariant variants={fadeInFromBottom}>
                <Body
                  ...
                  size={bodySize}
                  className={`${defaults.margin.body} ${_.get(fields, 'bodyClass') ?? _.get(fields, 'bodyClass')} text-gray-200`}
                />
              </MotionVariant>
              ...
              <MotionVariant variants={fadeInFromBottom}>
                <Body
                  ...
                  size={extraBodySize}
                  className={`${defaults.margin.extraBody} ${_.get(fields, 'extraBodyClass') ?? _.get(fields, 'extraBodyClass')} text-gray-200`}
                />
              </MotionVariant>
